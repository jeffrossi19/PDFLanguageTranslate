# -*- coding: utf-8 -*-
"""TranslatePDFIngForPt.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ehfNI90_a4tyaVOCYy2iM_3IUYssW81j
"""
...
def translate_large_pdf(pdf_path, output_dir):
    ...
    with open(os.path.join(output_dir, "arquivo_traduzido_final.pdf"), 'wb') as final_pdf:
        writer = PdfWriter()
    ...
    print(f"Arquivo traduzido completo salvo em: {os.path.join(output_dir, 'arquivo_traduzido_final.pdf')}")

# Caminho do arquivo PDF local
input_pdf = r"C:\Projetos\Tradutor\teste.pdf"  # Substitua pelo caminho do seu arquivo

# Diretório de saída local
output_directory = r"C:\Projetos\Tradutor"  # Substitua pelo diretório de saída
